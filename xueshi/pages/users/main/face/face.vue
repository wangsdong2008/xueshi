	...
	<view class="container">
		<view class="page-body uni-content-info">
			...
			<view class='cropper-config'>
				...
				<button type="warn" @click="saveImage" style='margin-top: 30rpx;'> 保存头像 </button>
			</view>
...
<script>
	...
	let PAGE_X, // 手按下的x位置
		...
		INIT_DRAG_POSITION = 10, // 初始化屏幕宽度和裁剪区域的宽度之差，用于设置初始化裁剪的宽度
				...
				url : _self.ChangeUserFaceUrl,
					...
					success: (res) => {
						...
						if(parseInt(data.status) == 3){	
							...
							_self.navigateTo('../account/account');
						}
					}
				},"1",""); 
				...
				ctx.draw(true, () => {
					...
					uni.canvasToTempFilePath({
						...
						success: function (res) {
							...
							_self.imgdata = res.tempFilePath;
						}
					});
				});
			},
