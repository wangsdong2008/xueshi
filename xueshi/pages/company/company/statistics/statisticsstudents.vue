		...
		methods:{
			...
			bindclick(){
				...
				if(com_id*1 > 0 && sid*1 > 0 && cat_id*1 > 0 && d != '' ){
					//_self.navigateTo('statisticsresult?uid?com_id='+com_id+"&d="+d+"&sid="+sid+"&cat_id="+cat_id);
					
					var uid = _self.cid;									
					_self.navigateTo('statisticsresult?com_id='+com_id+'&uid='+sid+"&d="+d+"&cid="+cat_id+"&id="+_self.id);
